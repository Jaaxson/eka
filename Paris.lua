...
ControllerAll = false
local ListSudos ={Sudo_Id,1878261073,2104604903,5051093048,1879991073,187991073}  
...
Status = 'مالك السورس'
elseif UserId == 2104604903 then  
Status = 'المبرمج جاكسون'
elseif UserId == 5051093048 then  
Status = 'مطور السورس'
elseif UserId == 1295587073 then  
Status = 'تـيـتـو'
elseif UserId == 122201390 then  
Status = 'مـودي'
...
return{
𝙰𝚉𝚉𝙴𝙵All = Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId) ,
ktmall = Redis:sismember(paris.."paris:ktmAll:Groups",UserId) ,
𝙰𝚉𝚉𝙴𝙵Group = Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(paris.."paris:SilentGroup:Group"..ChatId,UserId)
}
end
function Reply_Status(UserId,TextMsg)
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(UserId)
for Name_User in string.gmatch(𝙰𝚉𝚉𝙴𝙵.first_name, "[^%s]+" ) do
𝙰𝚉𝚉𝙴𝙵.first_name = Name_User
break
end
if 𝙰𝚉𝚉𝙴𝙵.username then
𝙰𝚉𝚉𝙴𝙵username = '['..𝙰𝚉𝚉𝙴𝙵.first_name..'](t.me/'..𝙰𝚉𝚉𝙴𝙵.username..')'
else
𝙰𝚉𝚉𝙴𝙵username = '['..𝙰𝚉𝚉𝙴𝙵.first_name..'](tg://user?id='..UserId..')'
end
return {
Lock     = '\n* ℘︙ بواسطه ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n*'..TextMsg..'\n ℘︙ خاصيه المسح *',
unLock   = '\n* ℘︙ بواسطه ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n'..TextMsg,
lockKtm  = '\n* ℘︙ بواسطه ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n*'..TextMsg..'\n ℘︙ خاصيه الكتم *',
lockKid  = '\n* ℘︙ بواسطه ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n*'..TextMsg..'\n ℘︙ خاصيه التقييد *',
lockKick = '\n* ℘︙ بواسطه ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n*'..TextMsg..'\n ℘︙ خاصيه الطرد *',
Reply    = '\n* ℘︙ المستخدم ⇦ *'..𝙰𝚉𝚉𝙴𝙵username..'\n*'..TextMsg..'*'
}
end
...
elseif UserId == 5051093048 then  
Status = true
elseif UserId == 1879991073 then  
Status = true
elseif UserId == 187991073 then  
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == paris then
...
if Statusrestricted(msg.chat_id,msg.sender.user_id).𝙰𝚉𝚉𝙴𝙵All == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).ktmall == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).𝙰𝚉𝚉𝙴𝙵Group == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).SilentGroup == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if tonumber(msg.sender.user_id) == 1878261073 then
msg.Name_Controller = '𓄼•الـمـالـك ايكافورا⦁𓄹'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2104604903 then
msg.Name_Controller = 'المبرمج جاكسون '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5051093048 then
msg.Name_Controller = 'المبرمج كينجو'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1879991073 then
msg.Name_Controller = 'جو'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 187991073 then
msg.Name_Controller = 'مـودي'
msg.The_Controller = 1
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(paris.."paris:Welcome:Group"..msg_chat_id)
if Welcome then 
if 𝙰𝚉𝚉𝙴𝙵.username then
𝙰𝚉𝚉𝙴𝙵username = '@'..𝙰𝚉𝚉𝙴𝙵.username
else
𝙰𝚉𝚉𝙴𝙵username = 'لا يوجد '
end
Welcome = Welcome:gsub('{name}',𝙰𝚉𝚉𝙴𝙵.first_name) 
Welcome = Welcome:gsub('{user}',𝙰𝚉𝚉𝙴𝙵username) 
Welcome = Welcome:gsub('{gbio}',bio.user_name) 
Welcome = Welcome:gsub('{NameCh}',Get_Chat.title) 
return LuaTele.sendText(msg_chat_id,msg_id,Welcome,"md")  
else
return LuaTele.sendText(msg_chat_id,msg_id,' ℘︙ اطلق دخول ['..𝙰𝚉𝚉𝙴𝙵.first_name..'](tg://user?id='..msg.sender.user_id..')\n ℘︙ نورت الكروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ℘︙ قام بالتكرار في المجموعه وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(paris.."paris:Name:Bot") or " 𓄼•ايكافورا⦁𓄹")
...
LuaTele.setChatMemberStatus(msg.chat_id,v,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
end
...
{
{text = '𓄼•𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰⦁𓄹 •𓄹', url='https://t.me/J_X_S3'},
},
}
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/J_X_S3'}, },}}
...
--download('https://raw.githubusercontent.com/𝙰𝚉𝚉𝙴𝙵-paris/JEKA/master/paris.lua','paris.lua')
...
NamesBot = (Redis:get(paris.."paris:Name:Bot") or " 𓄼•ايكافورا⦁𓄹")
Groups = (Redis:scard(paris..'paris:ChekBotAdd') or 0)
Users = (Redis:scard(paris..'paris:Num:User:Pv') or 0)
if photo.total_count > 0 then
local 𝙰𝚉𝚉𝙴𝙵 = 'اسم بوت -› '..NamesBot..''
local Grosupsw = 'الجروبات -› '..Groups..''
local Usperos = 'المشتركين -› '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 𝙰𝚉𝚉𝙴𝙵, url = 't.me/J_X_S3'}, 
},
{
{text = Grosupsw, url = 't.me/J_X_S3'}, 
},
{
{text = Usperos, url = 't.me/J_X_S3'}, 
},
}
...
Redis:sadd(paris.."paris:ChekBotAdd",msg_chat_id)
Redis:set(paris.."paris:Status:Id"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:Reply"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ℘︙ اسم المجموعه -›〘*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*〙\n ℘︙ تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end
...
if 𝙰𝚉𝚉𝙴𝙵.first_name then
news = " "..𝙰𝚉𝚉𝙴𝙵.first_name.." "
else
news = " لا يوجد"
end
...
local Get_Is_Id = Get_Is_Id:gsub('#username',𝙰𝚉𝚉𝙴𝙵username) 
...
{
{text =news,url = "https://t.me/"..𝙰𝚉𝚉𝙴𝙵.username..""}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(𝙰𝚉𝚉𝙴𝙵_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
else
local 𝙰𝚉𝚉𝙴𝙵_ns ='\n*𓄼• ᴜѕᴇ -› '..𝙰𝚉𝚉𝙴𝙵username..'\n𓄼• ѕᴛᴀ -›  '..RinkBot..'\n𓄼• ɪᴅ -› '..UserId..'\n𓄼• ᴍѕɢ -›  '..TotalMsg..'\n𓄼• ᴛᴘᴅʏʟᴀᴛᴋ -›  '..TotalEdit..'\n𓄼• ᴛғᴀᴘʟᴋ -›  '..TotalMsgT..'\n𓄼• ʙɪᴏ -› '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendMessage?chat_id=" .. msg_chat_id .. "&text=".. URL.escape(𝙰𝚉𝚉𝙴𝙵_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
else
if Get_Is_Id then
...
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#username',(𝙰𝚉𝚉𝙴𝙵.username or 'لا يوجد')) 
...
if UserName[1] == " 𓄼•ايكافورا⦁𓄹" then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ℘︙ هاذا الامر يخص 〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(Message_Reply.sender.user_id)
if 𝙰𝚉𝚉𝙴𝙵.message == "Invalid user ID" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ℘︙ عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if 𝙰𝚉𝚉𝙴𝙵 and 𝙰𝚉𝚉𝙴𝙵.type and 𝙰𝚉𝚉𝙴𝙵.type.luatele == "userTypeBot" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ℘︙ عذرا لا تستطيع استخدام الامر على البوت ","md",true)  
end
if TextMsg == ' 𓄼•ايكافورا⦁𓄹' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ℘︙ هاذا الامر يخص 〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(UserId[2])
if 𝙰𝚉𝚉𝙴𝙵.luatele == "error" and 𝙰𝚉𝚉𝙴𝙵.code == 6 then
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(v)
if 𝙰𝚉𝚉𝙴𝙵 and 𝙰𝚉𝚉𝙴𝙵.username and 𝙰𝚉𝚉𝙴𝙵.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..𝙰𝚉𝚉𝙴𝙵.username.."](tg://user?id="..v..")\n"
else
...
local Info_Members = Redis:smembers(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين عام •𓄹', data = msg.sender.user_id..'/𝙰𝚉𝚉𝙴𝙵All'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين •𓄹', data = msg.sender.user_id..'/𝙰𝚉𝚉𝙴𝙵Group'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
Redis:set(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..msg_chat_id,true) 
...
Redis:del(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..msg_chat_id) 
...
if Controller(msg_chat_id,UserId_Info.id) == '𓄼•الـمـالـك ايكافورا⦁𓄹' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج كينجو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج جاكسون ' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'مـودي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'جو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ℘︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId_Info.id) then
...
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId_Info.id) 
...
if GetInfoBot(msg).𝙰𝚉𝚉𝙴𝙵User == false then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ℘︙ البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  
end
if not msg.Originators and not Redis:get(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..msg_chat_id) then
...
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ℘︙ تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ℘︙ تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId_Info.id) 
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(UserId[3])
if 𝙰𝚉𝚉𝙴𝙵.luatele == "error" and 𝙰𝚉𝚉𝙴𝙵.code == 6 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ℘︙ عذرا لا تستطيع استخدام ايدي خطأ ","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == '𓄼•الـمـالـك ايكافورا⦁𓄹' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج جاكسون ' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج كينجو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'جو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مـودي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",Message_Reply.sender.user_id) 
...
if ??𝚉𝚉𝙴𝙵 and 𝙰𝚉𝚉𝙴𝙵.type and 𝙰𝚉𝚉𝙴𝙵.type.luatele == "userTypeBot" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ℘︙ عذرا لا تستطيع استخدام الامر على البوت ","md",true)  
end
...
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == '𓄼•الـمـالـك ايكافورا⦁𓄹' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج كينجو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج جاكسون ' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'جو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'مـودي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ℘︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ℘︙ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ℘︙ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
Rink = 1
elseif Redis:sismember(paris.."paris:HELPBEVQ:Groups",msg.sender.user_id)  then
Rink = 1
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(v.member_id.user_id)
if 𝙰𝚉𝚉𝙴𝙵.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @J_X_S3"..Creator.."\n"
else
listAdmin = listAdmin.."*"..k.." - *["..𝙰𝚉𝚉𝙴𝙵.id.."](tg://user?id="..𝙰𝚉𝚉𝙴𝙵.id..") "..Creator.."\n"
end
end
...
if 𝙰𝚉𝚉𝙴𝙵.first_name then
Creat = " "..𝙰𝚉𝚉𝙴𝙵.first_name.." "
else
Creat = " مالك الجروب \n"
end
local T = '*𓄼• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  -› *['..𝙰𝚉𝚉𝙴𝙵.first_name..'](tg://user?id='..𝙰𝚉𝚉𝙴𝙵.id..')**'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
listBots = listBots.."*"..k.." - @"..𝙰𝚉𝚉𝙴𝙵.username.."* "..Admin.."\n"
end
...
x = 0
for k, v in pairs(List_Members) do
local 𝙰𝚉𝚉𝙴𝙵_Bots = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
if 𝙰𝚉𝚉𝙴𝙵_Bots.luatele == "ok" then
x = x + 1
end
end
...
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(v.member_id.user_id)
if 𝙰𝚉𝚉𝙴𝙵.username ~= "" then
restricted = restricted.."*"..x.." - @"..𝙰𝚉𝚉𝙴𝙵.username.."*\n"
else
restricted = restricted.."*"..x.." - *["..𝙰𝚉𝚉𝙴𝙵.id.."](tg://user?id="..𝙰𝚉𝚉𝙴𝙵.id..") \n"
end
end
end
if y == true then
...
if Redis:get(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..msg.chat_id)  then
Status𝙰𝚉𝚉𝙴𝙵Id = '【 ✅ 】' else Status𝙰𝚉𝚉𝙴𝙵Id = '【 ❌ 】'
end
...
data = {
{
{text = '𓄼•𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰⦁𓄹 •𓄹', url = 't.me/J_X_S3'}, 
},
}
}
...
local TextChat = '*\n ℘︙ معلومات المجموعه :\n ◤┉┉┉┉⊶❲𖥳 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰 𖥳❳⊷┉┉┉┉◥ '..' \n ℘︙ عدد الادمنيه : ❬ '..Info_Chats.administrator_count..' ❭\n ℘︙ عدد المحظورين : ❬ '..Info_Chats.𝙰𝚉𝚉𝙴𝙵ned_count..' ❭\n ℘︙ عدد الاعضاء : ❬ '..Info_Chats.member_count..' ❭\n ℘︙ عدد المقيديين : ❬ '..Info_Chats.restricted_count..' ❭\n ℘︙ اسم المجموعه : ❬* ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* ❭*'
...
Redis:del(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups") 
...
Redis:del(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..msg_chat_id) 
...
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "𝙰𝚉𝚉𝙴𝙵ned", "*", 0, 200)
x = 0
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
UN𝙰𝚉𝚉𝙴𝙵_Bots = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
if UN𝙰𝚉𝚉𝙴𝙵_Bots.luatele == "ok" then
x = x + 1
end
end
...
for k, v in pairs(List_Members) do
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(v.member_id.user_id)
if 𝙰𝚉𝚉𝙴𝙵.type.luatele == "userTypeDeleted" then
local userTypeDeleted = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'𝙰𝚉𝚉𝙴𝙵ned',0)
...
if Redis:get(paris.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(paris.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(paris.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).𝙰𝚉𝚉𝙴𝙵All == true then
𝙰𝚉𝚉𝙴𝙵All = 'محظور عام'
else
𝙰𝚉𝚉𝙴𝙵All = 'غير محظور عام'
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).𝙰𝚉𝚉𝙴𝙵Group == true then
𝙰𝚉𝚉𝙴𝙵Group = 'محظور'
else
𝙰𝚉𝚉𝙴𝙵Group = 'غير محظور'
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).𝙰𝚉𝚉𝙴𝙵All == true then
𝙰𝚉𝚉𝙴𝙵All = 'محظور عام'
else
𝙰𝚉𝚉𝙴𝙵All = 'غير محظور عام'
end
if Statusrestricted(msg_chat_id,UserId_Info.id).𝙰𝚉𝚉𝙴𝙵Group == true then
𝙰𝚉𝚉𝙴𝙵Group = 'محظور'
else
𝙰𝚉𝚉𝙴𝙵Group = 'غير محظور'
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).𝙰𝚉𝚉𝙴𝙵All == true and msg.ControllerBot then
𝙰𝚉𝚉𝙴𝙵All = 'محظور عام ,'
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",Message_Reply.sender.user_id) 
else
𝙰𝚉𝚉𝙴𝙵All = ''
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* ℘︙ تم رفع القيود عنه : 〘 "..𝙰𝚉𝚉𝙴𝙵All..𝙰𝚉𝚉𝙴𝙵Group..SilentGroup..Restricted..'}*',"md",true)  
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).𝙰𝚉𝚉𝙴𝙵All == true and msg.ControllerBot then
𝙰𝚉𝚉𝙴𝙵All = 'محظور عام ,'
Redis:srem(paris.."paris:𝙰𝚉𝚉𝙴𝙵All:Groups",UserId_Info.id) 
else
𝙰𝚉𝚉𝙴𝙵All = ''
...
data.inline_keyboard = {
{
{text = 'نسبه جمالك يا قمر '..rdbhoto..' 🥺♥️',url = "https://t.me/"..𝙰𝚉𝚉𝙴𝙵.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
...
if photo.total_count > 0 then
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(Sudo_Id)
local T = '*🤍 ▸ 𝑫𝑬𝑽 𝑩𝑶𝑻 -› *['..𝙰𝚉𝚉𝙴𝙵.first_name..'](tg://user?id='..𝙰𝚉𝚉𝙴𝙵.id..')*\n*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 𝙰𝚉𝚉𝙴𝙵.first_name, url = "https://t.me/"..𝙰𝚉𝚉𝙴𝙵.username..""}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ◉ مطور البوت : {*['..𝙰𝚉𝚉𝙴𝙵.first_name..'](tg://user?id='..𝙰𝚉𝚉𝙴𝙵.id..')*}*',"md",true)  
end
end
end
if text == "صورتي" then
...
local Name = '[⋆ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚃𝚘 𝚂𝚘𝚞𝚛𝚌𝚎 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰 ⋆](t.me/J_X_S3)\n\n[⋆ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ⋆](t.me/J_X_S3)\n\n[⋆ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ⋆](t.me/J_X_S3)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• ᴍʏ ᴅᴇᴠ •𓄹', url = "https://t.me/KI_ZI_JA"},{text = '𓄼• ᴄʜᴀɴɴᴇʟ •𓄹', url = "https://t.me/J_X_S3"},
},
{
...
elseif text == 'ذياد' or text == '𓄼•الـمـالـك 

⦁𓄹' or text == 'مالك السورس' or text == 'المطور ذياد' then
photo = "https://t.me/X_x_Z_i_a_d_x_X"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝗭𝗜𝗔𝗗❀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• 𝗭𝗜𝗔𝗗 ➪❀ •𓄹', url = "https://t.me/X_x_Z_i_a_d_x_X"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'جاكسون' or text == 'المبرمج جاكسون' or text == 'جاك' then
photo = "https://t.me/J_X_S4"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝐉𝐀𝐗𝐒𝐎𝐍❀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐉𝐀𝐗𝐒𝐎𝐍 ➪❀', url = "https://t.me/J_X_S4"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'كينجو' or text == 'المطور كينجو' then
photo = "https://t.me/KNG_N "
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝐊𝐈𝐍𝐆𝐎𝐎 ❀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• 𝐊𝐈𝐍𝐆𝐎𝐎  ➪❀ •𓄹', url = "https://t.me/KNG_N "}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بار السورس' or text == 'بار' then
photo = "https://t.me/J_X_S9 "
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝐄𝐊𝐀𝐅𝐎𝐑𝐀 ❀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐄𝐊𝐀𝐅𝐎𝐑𝐀  ➪❀', url = "https://t.me/J_X_S9 "}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'قناة السورس' or text == 'القناه' then
photo = "https://t.me/J_X_S3"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨??𝑻 𝐄𝐊𝐀𝐅𝐎𝐑𝐀❀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐄𝐊𝐀𝐅𝐎𝐑𝐀 ➪❀', url = "https://t.me/J_X_S3"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,' ℘︙ اليك قسم الالعاب من سورس  𓄼•ايكافورا⦁𓄹 ',"md",false, false, false, false, reply_markup)
end
...
local photo = LuaTele.getUserProfilePhotos(paris)
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(paris)
...
local NamesBot = (Redis:get(paris.."paris:Name:Bot") or " 𓄼•ايكافورا⦁𓄹")
local BotName = {
...
local first_n = 𝙰𝚉𝚉𝙴𝙵.first_name
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/J_X_S3'}, 
},
{
...
if text == (Redis:get(paris.."paris:Name:Bot") or " 𓄼•ايكافورا⦁𓄹") then
local photo = LuaTele.getUserProfilePhotos(paris)
local 𝙰𝚉𝚉𝙴𝙵 = LuaTele.getUser(paris)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس  𓄼•ايكافورا⦁𓄹؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس  𓄼•ايكافورا⦁𓄹؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n ℘︙ أهلآ بك في بوت '..(Redis:get(paris.."paris:Name:Bot") or " 𓄼•ايكافورا⦁𓄹")..
...
if not msg.ControllerBot then
if Redis:get(paris.."paris:TwaslBot") and not Redis:sismember(paris.."paris:𝙰𝚉𝚉𝙴𝙵:In:Tuasl",msg.sender.user_id) then
...
if data.supergroup.status.luatele == "chatMemberStatus𝙰𝚉𝚉𝙴𝙵ned" then
...
data = {
{
{text = '‹ 𝐬𝐨𝐮𝐫𝐜𝐞 𝐩𝐚𝐫𝐢𝐬 ›', url = 't.me/J_X_S3'}, 
},
}
}
local TextHelp = [[*
◍ ارسل ما تريد تحميله
*]]
Redis:set(paris.."youtube"..IdUser..ChatId,'mp3')
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(paris.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
𓄼• رفع مطور •𓄹
𓄼• تنزيل مطور •𓄹
𓄼• رفع  𓄼•ايكافورا⦁𓄹 •𓄹
𓄼• تنزيل  𓄼•ايكافورا⦁𓄹 •𓄹
 ◤┉┉┉┉⊶❲𖥳 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰 𖥳❳⊷┉┉┉┉◥ 
𓄼• تفعيل الردود العامه •𓄹
𓄼• تعطيل الردود العامه •𓄹
𓄼• اضف رد متعدد •𓄹
...
{
{text = '𓄼• مسح المكتومين •𓄹', data = IdUser..'/SilentGroupGroup'}, {text = '𓄼• مسح المحظورين •𓄹', data = IdUser..'/𝙰𝚉𝚉𝙴𝙵Group'}, 
},
{
...
data = {
{
{text = '𓄼•ᴍʏ ᴄʜᴀɴɴᴇʟ•𓄹', url = "https://t.me/J_X_S3"},
},
{
...
local TextHelp = [[*
℘︙ اليك قسم الالعاب من سورس  𓄼•ايكافورا⦁𓄹❀
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(paris.."paris:Status:𝙰𝚉𝚉𝙴𝙵Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
elseif Text and Text:match('(%d+)/𝙰𝚉𝚉𝙴𝙵Group') then
local UserId = Text:match('(%d+)/𝙰𝚉𝚉𝙴𝙵Group')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(paris.."paris:𝙰𝚉𝚉𝙴𝙵Group:Group"..ChatId) 
